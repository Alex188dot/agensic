...
struct DetailState {
    ...
    transcript_chunks: Arc<Vec<TranscriptChunk>>,
    checkpoint_records: Arc<Vec<CheckpointRecord>>,
...
impl DetailState {
    fn new(session: SessionSummary, events: Vec<SessionEvent>, autoplay: bool) -> Self {
        ...
        let mut out = Self {
            ...
            git_checkpoint_records,
            transcript_chunks: Arc::new(transcript_chunks),
            checkpoint_records: Arc::new(checkpoint_records),
...
mod tests {
    ...
    fn exact_terminal_replay_sync_uses_transcript_seq_metadata() {
        let mut detail = DetailState {
            ...
            transcript_chunks: Arc::new(Vec::new()),
            checkpoint_records: Arc::new(Vec::new()),
