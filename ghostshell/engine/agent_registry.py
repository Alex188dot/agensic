...
DEFAULT_REMOTE_META_PATH = os.path.expanduser("~/.ghostshell/agent_registry.remote.meta.json")
DEFAULT_LOCAL_OVERRIDE_PATH = os.path.expanduser("~/.ghostshell/agent_registry.local.json")
